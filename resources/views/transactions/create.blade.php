<x-layout title="Transactions" headerTitle="Add New Transactions" :extend-header="true">
    
    <form action="{{ route('transactions.store') }}" method="post" style="max-width: 500px; margin: 0 auto; padding: 20px; border: 1px solid #ccc; border-radius: 8px; background-color: #f9f9f9;">
        @csrf
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="number" name="transaction_amount" id="transaction_amount" required style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;">
        </div>
        <div style="margin-bottom: 15px;">
            <label for="transaction_description" style="display: block; font-weight: bold; margin-bottom: 5px;">Transaction Description:</label>
            <textarea name="transaction_description" id="transaction_description" placeholder="Optional details about the transaction" style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;"></textarea>
        </div>
